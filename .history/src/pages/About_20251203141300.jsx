...
export default function AboutPage() {
  return (
    <section id="About" className="w-full py-20 px-6 bg-[#fdfcfb]">
      <motion.div
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 items-center">
          <div className="md:col-span-7 space-y-6">
            <p className="text-sm text-[#666666] font-semibold tracking-widest">
              ABOUT ME
            </p>

            <h2
              className="text-5xl md:text-7xl font-normal text-[#1a1a1a]"
              style={{
            ...
            <p className="text-[#666666] leading-relaxed max-w-2xl text-lg">
            ...
            <button className="px-6 py-3 rounded-full bg-[#1a1a1a] text-white 
          ...
          <div className="md:col-span-5 flex justify-center">
            <motion.div
              ...
              className="w-72 h-80 md:w-80 md:h-96 rounded-3xl bg-gray-100 overflow-hidden shadow-xl"
            >
              <img
                src="/about.jpg"
                alt="Temi"
