          ...
          <div className="grid md:grid-cols-3 gap-10 items-start">
            ...
            >
              ...
              <div className="p-10 flex-1 flex flex-col justify-between">
                ...
                <Link to="/collection/minimal" className="mt-8 text-[#1a1a1a] font-medium hover:underline">
                  Discover More →
                </Link>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="max-w-7xl mx-auto px-6 pb-40 grid md:grid-cols-3 gap-12">
                {[1, 2, 3, 4, 5, 6].map((i) => (
                  ...
                  >
                    <img
                      src={`https://images.unsplash.com/photo-150${i === 1 ? '963' : i === 2 ? '267' : i === 3 ? '323' : i === 4 ? '159' : i === 5 ? '577' : '473'}1172-${i}q80?w=800&h=1000&fit=crop`}
                      alt="Journal post"
                    ...
                    <div className="p-10">
                      ...
                      <a href="#" className="mt-6 inline-block text-[#1a1a1a] font-medium hover:underline">
                        Read Story →
                      </a>
                    </div>
                  </motion.article>
